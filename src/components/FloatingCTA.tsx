      ...
      <div className="bg-black/60 backdrop-blur-xl rounded-full p-1.5 md:p-2 border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.6)]">
        <div className="flex items-center gap-2 md:gap-3">
          ...
          >
            ...
            <span className="text-white text-xs md:text-sm" style={{ fontWeight: 600 }}>{t("contact")}</span>
          </button>
          ...
          >
            ...
            <span className="text-white text-sm md:text-base" style={{ fontWeight: 700 }}>{t("book")}</span>
          </button>
        </div>
      </div>
    </motion.div>
